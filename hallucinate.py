...
#from datasets.phototourism_mask_grid_sample import *
import math
...
if __name__ == "__main__":
    ...
    #dataset = Phototourism_mask_grid_sample()
    ...
    load_ckpt(model, './ckpts/epoch=5_16_slim.ckpt',model_name='model')
    ...
    for file_name in tqdm(files):
        ...
        #normalize = T.Normalize(mean=[0.485, 0.456, 0.406], std=[0.25, 0.25, 0.25])
        ...
        imageio.mimsave(os.path.join(dir_name, f'{fig_name}.gif'), imgs,duration =30)